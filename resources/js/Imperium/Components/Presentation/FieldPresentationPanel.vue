<template>
  <div>
    <div class="flow-root" v-if="presentationFields">
      <div class="-my-3 divide-y divide-gray-100 text-sm">
        <div
        ...
        >
          ...
          <dd class="sm:col-span-2">
            <component
              v-if="field.value"
              :is="field.presentationComponent"
              :field="field"
            ></component>
            <Message severity="secondary" variant="simple" v-else
...
import { resolveFieldPresentationComponent } from "@/Imperium/Utils/Resource/FieldPresentationMapper";
...
const presentationFields = computed(() =>
  mergeFields(resourceFields, props.data)
);
</script>
<style></style>