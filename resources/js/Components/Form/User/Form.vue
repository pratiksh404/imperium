<template>
    <div>
        <form @submit.prevent="submit">
            <TextInput label="Name" name="name" v-model="form.name" :error="form.errors.name" placeholder="User Name"
...
import TextInput from '@/Components/Form/Fields/TextField.vue'
...
const submit = () => {
    form[props.method](props.url, {
        ...
        onError: () => {
            toast.add({ severity: 'error', summary: 'Error', detail: 'User not created', life: 3000 });
        }
    })
};
