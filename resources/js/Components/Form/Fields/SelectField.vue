<template>
    <component :is="selectComponent" v-if="options.length > 0" :invalid="hasError" :placeholder="placeholder"
...
const selectComponent = computed(() => {
    ...
    return isMultiple ? resolveFieldComponent('primeMultiSelect') : resolveFieldComponent('primeSelect');
})
