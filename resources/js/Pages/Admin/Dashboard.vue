  ...
  <div>
      ...
      <div
        ...
        <div class="flex h-16 my-1 shrink-0 items-center justify-between">
          ...
          <button @click="toggleCollapsed"
            class="rounded-md p-1.5 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700" :class="collapsed
    ...
    <div :class="[
      ...
      <div
        ...
        <button type="button" class="-m-2.5 p-1 text-gray-200 dark:text-gray-700 lg:hidden bg-black dark:bg-gray-200"
